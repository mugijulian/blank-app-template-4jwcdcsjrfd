...
def generate_list_of_countries():
    countries_url = https://api.airvisual.com/v2/countries?key={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}
...
if category == "By City, State, and Country":
    ...
    url = https://api.airvisual.com/v2/nearest_city?key={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}
    ...
    if latitude and longitude:
        url = https://api.airvisual.com/v2/nearest_city?lat={latitude}&lon={longitude}&key={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}
        aqi_data_dict = requests.get(url).json()
